...
public:
        ...
        btScalar getMaxFy(btScalar load) const;

        /// load is the normal force in newtons, camber is in degrees
        btScalar getMaxMz(btScalar load) const;
...
private:
        ...
        btScalar PacejkaFy(btScalar alpha, btScalar Fz, btScalar friction_coeff, btScalar & max_Fy) const;

        /// pacejka magic formula function, aligning
        btScalar PacejkaMz(btScalar alpha, btScalar Fz, btScalar friction_coeff, btScalar & max_Mz) const;
